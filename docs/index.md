...
sole document display source.** Operator writes (REVIEW resolve) proxy to the
producer. GitHub Pages is a static pixel snapshot — not the Observatory.
...
source (pinned here as dist `mailroom` `@2c0bcac`, optional extra
`[pipeline]`); **[llm-entity-extraction](https://github.com/Exios66/llm-entity-extraction)**
